...
/**
 * Manages "Authentication" to WatchThemAll's backend service.  The SyncAdapter framework
 ...
 */
public class WtaAuthenticator extends AbstractAccountAuthenticator {

    public WtaAuthenticator(Context context) {
        super(context);
    }
